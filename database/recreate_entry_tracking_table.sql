-- ============================================
-- DROP AND RECREATE ENTRY_TRACKING TABLE
-- ============================================
...
CREATE INDEX idx_entry_tracking_symbol_tf ON entry_tracking(symbol, timeframe);
CREATE INDEX idx_entry_tracking_status ON entry_tracking(exit_status);
CREATE INDEX idx_entry_tracking_active ON entry_tracking(active);
CREATE INDEX idx_entry_tracking_validation ON entry_tracking(validation_status);
CREATE INDEX idx_entry_tracking_entry_datetime ON entry_tracking(entry_datetime DESC);
...
SELECT 'Entry tracking table recreated successfully!' AS status;